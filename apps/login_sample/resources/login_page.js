        ...
        boxView: SC.View.design({
            ...
            username: SC.View.design({
                ...
                field: SC.TextFieldView.design({
                    ...
                    isEnabledBinding: SC.Binding.from('LoginSample.loginController.isLogginIn')
                                                .bool()
            ...
            password: SC.View.design({
                ...
                childViews: 'label field'.w(),
                label: SC.LabelView.design({
                    layout: {left: 0, right: 3, bottom: 18, height: 26},
                    value: '_Password',
                    localize: YES,
                    textAlign: SC.ALIGN_RIGHT,
                    isEnabledBinding: SC.Binding.from('LoginSample.loginController.isLogginIn')
            ...
            loadingImage: SC.ImageView.design({
                ...
                useImageCache: NO,
                isVisibleBinding: 'LoginSample.loginController.isLogginIn'
            }),
